/**
 * jspsych-image-2afc
 * Josh de Leeuw, hacked by Benjamin Knopp
 *
 * plugin for displaying two stimuli and getting a keyboard response
 *
...
var image2afc = (function (jspsych) {
  'use strict';

  //var plugin = {};

  //jspsych.pluginAPI.registerPreload('image-2afc', 'stimulus', 'image');
  ...
  class Image2AFCPlugin {
      ...
      trial(display_element, trial) {
          ...
          if (trial.render_on_canvas) {
              ...
              //canvas.id = "jspsych-image-2afc-stimulus";
  ...
  Image2AFCPlugin.info = info;

  return Image2AFCPlugin;
